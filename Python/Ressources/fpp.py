...
# Fonctions Python Perso.

# Copyright Nyrlathotep 2018. All Rights reserved.


# Ces fonctions ont été récupérées sur internet (pythoncentral.io)
# ou créées par Nyrlathotep.
# Ce fichier les contient toutes, il peut être necéssaire de créer
# des modules avant de les utiliser.


# Maths

def frange(start, stop, step):
    """Fonction identique à range() mais fonctionnant avec des flottants"""
    i = start
    while i < stop:
        yield i
        i += step
...
# Entrées utilisateur avec un type spécifique
