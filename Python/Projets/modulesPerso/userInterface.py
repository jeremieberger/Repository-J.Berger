...
Les fonctions test* servent à tester si une variable
peut être convertie en un type donné.
...
def testLong(var):
    """Fonction servant à tester si une variable peut être convertie en
    type Long.
    Elle renvoie True si c'est le cas et False si ce n'est pas possible."""
...
def userRestart():
    ...
    Il peut répondre par o ou n et la fonction se répétera
    si il répond autre chose.
...
def afficher_flottant(flottant):
    ...
    représentant la troncature de ce nombre.
